...
import logging
logger = logging.getLogger('mybrowser_lib')

from . helpers import get_builder, show_uri, get_help_uri

# This class is meant to be subclassed by MybrowserWindow.  It provides
...
class Window(Gtk.Window):
    ...
    def __new__(cls):
        ...
        """
        builder = get_builder('MybrowserWindow')
        new_object = builder.get_object("mybrowser_window")
    ...
    def finish_initializing(self, builder):
        ...
        self.settings = Gio.Settings("net.launchpad.mybrowser")
        ...
        try:
            ...
            LaunchpadIntegration.set_sourcepackagename('mybrowser')
        except ImportError:
            pass
        ...
        try:
            from mybrowser import indicator
    ...
    def on_mnu_about_activate(self, widget, data=None):
        """Display the about box for mybrowser."""
    ...
    def on_mnu_preferences_activate(self, widget, data=None):
        """Display the preferences window for mybrowser."""
    ...
    def on_mnu_close_activate(self, widget, data=None):
        """Signal handler for closing the MybrowserWindow."""
        self.destroy()

    def on_destroy(self, widget, data=None):
        """Called when the MybrowserWindow is closed."""
