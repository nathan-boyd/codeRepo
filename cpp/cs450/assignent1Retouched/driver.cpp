...
void main()
{
	...
	cout << "\ninequality operator testing" << endl;
	{
		Array test1 = Array(200, 'f');
		Array test2 = Array(100, 'f');

		if (test1 != test2) 
		{
			testPassed("inequality 1");
		}
	...
	cout << "\nassignment operator testing" << endl;
	{
		Array test7 = Array(5, 'f');
		Array test8 = Array(500, 'b');
