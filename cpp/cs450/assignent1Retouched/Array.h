...
public:
  ...
  // Robert, please remove this methods for the array class. They are not
  // needed and breaks the specification of the array. cur_size_ and max_size_
  // work together and are controlled by resize (). You should not be exposing
  // any extra method for getting the size, or max size. This is something
  // that is done in Java and C#, and is actually bad because you are breaking
  // the information hiding rule.

  /* RNB CHANGED removed set_size() and set_max_size() functions
...
private:
  ...
  /// DEFINE ANY HELPER METHODS HERE
	...
	const bool indexInRange(size_t index) const; 
