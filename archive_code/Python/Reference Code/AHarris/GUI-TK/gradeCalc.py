...
class App(Tk):
  ...
  def addLabs(self):    
    ...
    Label(self, text = "Lab Assignments",
          font = ("Helvetica", "16", "bold italic")).grid(columnspan = 2)
  ...
  def addExams(self):
    ...
    Label(self, text = "Exams",
          font = ("Helvetica", "16", "bold italic")).grid(row = 5, columnspan = 2)
  ...
  def addProj(self):
    ...
    Label(self, text = "Final Project",
          font = ("Helvetica", "16", "bold italic")).grid(row = 8, columnspan = 2)
  ...
  def addOutput(self):
    ...
    Label(self, text = "Overal Percent").grid(row = 13, column = 0)
