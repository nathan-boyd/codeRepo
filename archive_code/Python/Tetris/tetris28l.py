import curses; from random import randrange; curses.initscr(); curses.curs_set(0); win = curses.newwin(18,18,0,0); win.keypad(1); win.nodelay(1); f = [ [0x315,0x4cd,0x13f,0xc47],[0x31d,0x4cf,0x137,0xc45],[0x374,0x374,0x374,0x374],[0x741,0x51c,0xdc3,0xf34],[0xfc1,0x73c,0x543,0xd14],[0x311,0x4cc,0x133,0xc44],[0xc34,0x341,0x41c,0x1c3]]
def chkFig(crds,s): 
...
while 1: # main loop
    ...
    if not putFig(FigPos,1):
        MoveFig(FigPos,key, -1); putFig(FigPos,1)
        if FigPos[1]==3: break
