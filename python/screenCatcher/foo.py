...
g1 = Radiobutton(c, text=gifts['card'], variable=gift, value='card');
g2 = Radiobutton(c, text=gifts['flowers'], variable=gift, value='flowers');
g3 = Radiobutton(c, text=gifts['nastygram'], variable=gift, value='nastygram');
send = Button(c, text='Send Gift', command=sendGift, default='active')
sentlbl = Label(c, textvariable=sentmsg, anchor='center');
